...
class ConfigLoader:
    ...
    def get(self, key: str, default: Optional[T] = None, required: bool = False) -> Union[Any, T]:
        """
        ...
        for k in keys:
            if isinstance(value, dict) and k in value:
                ...
                if required:
                    raise MissingConfigError(f"Required configuration key not found: '{key}'")
                return default
    ...
    def get_section(self, section: str) -> Dict[str, Any]:
        ...
        if section not in self._config:
            raise MissingConfigError(f"Configuration section not found: '{section}'")
    ...
    def processed_dir(self) -> Path:
        ...
        path = os.getenv(
            "PROCESSED_DIR", self.get("document_processing.processed_dir", "data/processed")
        )
        return self._project_root / path
    ...
    def vectordb_dir(self) -> Path:
        ...
        path = os.getenv(
            "CHROMA_PERSIST_DIR", self.get("vector_database.persist_directory", "data/vectordb")
        )
        return self._project_root / path
    ...
    def allowed_extensions(self) -> List[str]:
        ...
        return self.get(
            "document_processing.allowed_extensions", default=[".pdf", ".docx", ".txt", ".md"]
        )
